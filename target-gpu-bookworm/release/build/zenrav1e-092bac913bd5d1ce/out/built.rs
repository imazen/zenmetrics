...
#[allow(dead_code)]
pub static PKG_VERSION: &str = "0.1.4";
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(dead_code)]
pub static PKG_VERSION_PATCH: &str = "4";
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(dead_code)]
pub static PKG_AUTHORS: &str = "Thomas Daede <tdaede@xiph.org>:Imazen <oss@imazen.io>";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The name of the package."#]
#[allow(dead_code)]
pub static PKG_NAME: &str = "zenrav1e";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The description."#]
#[allow(dead_code)]
pub static PKG_DESCRIPTION: &str = "AV1 encoder optimized for still and animated AVIF images (Imazen fork of rav1e)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The homepage."#]
#[allow(dead_code)]
...
#[doc=r#"The license."#]
#[allow(dead_code)]
pub static PKG_LICENSE: &str = "AGPL-3.0-only OR LicenseRef-Imazen-Commercial";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The source repository as advertised in Cargo.toml."#]
#[allow(dead_code)]
pub static PKG_REPOSITORY: &str = "https://github.com/imazen/zenrav1e/";
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(dead_code)]
pub static RUSTC: &str = "/usr/local/rustup/toolchains/1.98.0-x86_64-unknown-linux-gnu/bin/rustc";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/usr/local/rustup/toolchains/1.98.0-x86_64-unknown-linux-gnu/bin/rustdoc";
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(dead_code)]
pub static FEATURES: [&str; 2] = ["enough", "stop"];
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The features as a comma-separated string."#]
#[allow(dead_code)]
pub static FEATURES_STR: &str = "enough, stop";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The features as above, as lowercase strings."#]
#[allow(dead_code)]
pub static FEATURES_LOWERCASE: [&str; 2] = ["enough", "stop"];
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The feature-string as above, from lowercase strings."#]
#[allow(dead_code)]
pub static FEATURES_LOWERCASE_STR: &str = "enough, stop";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/usr/local/rustup/toolchains/1.98.0-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.98.0 (88d9e12ae 2026-08-18)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/usr/local/rustup/toolchains/1.98.0-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/usr/local/rustup/toolchains/1.98.0-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
