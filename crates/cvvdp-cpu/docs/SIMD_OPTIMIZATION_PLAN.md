...
| Chunk | Priority | Self % attacked | Expected ms saved | Risk | Dep |
|-------|----------|----------------:|------------------:|------|-----|
| 1 — SIMD gaussian_blur_sigma3 | HIGHEST | 32.06% | 62-93 ms | LOW | — |
| 2 — SIMD gausspyr reduce/expand | HIGH | 23.73% | 37-50 ms | LOW-MED | — |
| 3 — SIMD safe_pow | MED | 10.26% | 7-10 ms | LOW | — |
| 4 — TLS pool + pre-clear | MED | 4.65% + 10.63% | 5-8 ms | ZERO | — |
| 5 — SIMD CSF + persistent rayon pool | LOW-MED | ~3.0% + 10.63% | 15-20 ms | LOW | Ch3 |
