...
fn main() {
    ...
    for &(w, h) in &[(64u32, 64u32), (256, 256), (512, 512), (1024, 1024), (2048, 2048), (4096, 3072)] {
    ...
    for &(mem_gb, mem_name) in &[(8.0_f64, "8 GB (RTX 3070)"), (12.0, "12 GB (RTX 3060)"), (16.0, "16 GB (RTX 4070 Ti S)"), (24.0, "24 GB (RTX 3090/4090)")] {
        print!("  {mem_name:<24} ");
