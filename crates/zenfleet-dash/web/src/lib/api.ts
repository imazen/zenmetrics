// Typed client for the zenfleet-dash control-plane API. Mirrors the Rust DTOs in
// crates/zenfleet-dash/src/{views,fleet}.rs and the control responses in bin/server.rs.
