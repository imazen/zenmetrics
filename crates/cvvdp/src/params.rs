...
///
/// ```
/// use cvvdp::params::SRGB_LINEAR_TO_DKL as M;
///
...
///
/// ```
/// use cvvdp::params::BT2020_LINEAR_TO_DKL as M;
...
/// // saturated).
/// use cvvdp::params::SRGB_LINEAR_TO_DKL as S;
...
///
/// ```
/// use cvvdp::params::DISPLAY_P3_LINEAR_TO_DKL as M;
/// let a_sum = M[0][0] + M[0][1] + M[0][2];
...
///
/// ```
/// use cvvdp::params::{CvvdpParams, PerfMode};
...
///
/// ```
/// use cvvdp::{CvvdpParams, PerfMode};
/// use cvvdp::params::DisplayModel;
///
