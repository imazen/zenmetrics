...
8t; ~160 ms/frame at 1080p/8t where fast-ssim2 0.9.0 runs ~135 —
roughly at parity through 720p; ~1.0 GB peak RSS, ~0.7 GB with
`low_memory`; the streaming bound is the temporal-filter window, not
a small footprint).
