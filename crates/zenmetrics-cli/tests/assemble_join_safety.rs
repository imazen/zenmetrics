...
//! guarantees for `zenmetrics assemble`.
//!
...
//!
//! Run: `cargo test -p zenmetrics-cli --features sweep --test assemble_join_safety`

use zenmetrics_cli::assemble::join::{
    JoinHow, assert_no_leaked_columns, assert_not_constant_per_ref_tuned, attach_positional,
    safe_join,
};
use zenmetrics_cli::assemble::key::PairKey;
