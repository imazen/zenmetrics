...
//! `zen-metrics assemble` — typed, full-key corpus join.
//!
...
/// `zen-metrics assemble` arguments. Mirrors `build_per_codec_training.py`'s
...
/// Entry point for `zen-metrics assemble`.
