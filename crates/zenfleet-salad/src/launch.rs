...
use zenfleet_cloud::{DEFAULT_TTL_SECONDS, Permission, ScopedR2Cred, mint_scoped_r2_cred};
...
/// (see `zenfleet_cloud::r2creds` gotchas). The existing env-injection
...
impl SaladApi {
    ...
    ///
    /// This is the provider-agnostic minter (`zenfleet_cloud::r2creds`)
