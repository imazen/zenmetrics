...
//!
//! ## Mapping onto the [`zenfleet_cloud::JobQueue`] trait
//!
...
use zenfleet_cloud::{Chunk, ChunkId, ChunkOutcome, CloudError};
...
/// [`zenfleet_cloud::run_worker`] loop's single-flight, fully-sync
/// contract intact.
...
impl zenfleet_cloud::JobQueue for SaladJobQueue {
