...
pub fn build_user_data(spec: &WorkerBootstrap) -> String {
    ...
    script.push_str("# zenfleet-hetzner worker bootstrap (cloud-init user_data)\n");
    ...
    push_env_line(&mut script, "RUST_LOG", "info,zenfleet_hetzner=info");
...
mod tests {
    ...
    fn sample_spec() -> WorkerBootstrap {
        ...
        WorkerBootstrap {
            image: "ghcr.io/imazen/zenmetrics-sweep-hetzner:v1".into(),
