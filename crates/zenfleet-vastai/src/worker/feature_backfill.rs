...
//!    `zenmetrics_cli::metrics::run_zensim_with_features` to get
//!    `(score, [f64; 300])`.
...
use zenmetrics_cli::metrics::run_zensim_with_features;
...
fn compute_features_for_rows(
    ...
    let mut ref_cache: std::collections::HashMap<
        String,
        std::sync::Arc<zenmetrics_cli::decode::Rgb8Image>,
    ...
    for row in rows {
        ...
        let reference: std::sync::Arc<zenmetrics_cli::decode::Rgb8Image> =
