...
// `zensim_gpu::session::{cleanup_stream, stream_reserved_bytes}` keep resolving.
#[doc(hidden)]
pub use zenmetrics_gpu_core::{cleanup_stream, stream_reserved_bytes};

/// Build an opaque zensim scorer bound to the private cubecl stream
...
pub fn new_opaque_on_stream(
    ...
    match backend {
        #[cfg(feature = "cuda")]
        Backend::Cuda => ZensimOpaque::build_from_client::<cubecl::cuda::CudaRuntime>(
        ...
        #[cfg(feature = "wgpu")]
        Backend::Wgpu => ZensimOpaque::build_from_client::<cubecl::wgpu::WgpuRuntime>(
        ...
        #[cfg(feature = "cpu")]
        Backend::Cpu => ZensimOpaque::build_from_client::<cubecl::cpu::CpuRuntime>(
