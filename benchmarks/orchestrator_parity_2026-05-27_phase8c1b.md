...
Binary: `/home/lilith/work/zen/zenmetrics--phase8c1-b/target/release/zenmetrics`  
Total cells: 54  
...
| cvvdp | 4096 | 20 |  |  | inf | 1.000000e-03 | FAIL |
| cvvdp | 4096 | 50 |  |  | inf | 1.000000e-03 | FAIL |
| cvvdp | 4096 | 80 |  |  | inf | 1.000000e-03 | FAIL |
...
- **cvvdp size=4096 q=20** (value): legacy= orch= diff=inf > tol=1.000000e-03. Notes: legacy_err= Ryzen 9 7950X 16-Core Processor cache=/home/lilith/.cache/zenmetrics/capability_6bfc55005d24a81a.toml
error: orchestrator: chooser: no feasible backend (considered 4 candidates) (backends tried: [])
; orch_err=Ryzen 9 7950X 16-Core Processor cache=/tmp/orch_parity_pi9ihn9j/cache/capability_6bfc55005d24a81a.toml
error: orchestrator: chooser: no feasible backend (considered 4 candidates) (backends tried: [])

- **cvvdp size=4096 q=50** (value): legacy= orch= diff=inf > tol=1.000000e-03. Notes: legacy_err= Ryzen 9 7950X 16-Core Processor cache=/home/lilith/.cache/zenmetrics/capability_6bfc55005d24a81a.toml
error: orchestrator: chooser: no feasible backend (considered 4 candidates) (backends tried: [])
; orch_err=Ryzen 9 7950X 16-Core Processor cache=/tmp/orch_parity_pi9ihn9j/cache/capability_6bfc55005d24a81a.toml
error: orchestrator: chooser: no feasible backend (considered 4 candidates) (backends tried: [])

- **cvvdp size=4096 q=80** (value): legacy= orch= diff=inf > tol=1.000000e-03. Notes: legacy_err= Ryzen 9 7950X 16-Core Processor cache=/home/lilith/.cache/zenmetrics/capability_6bfc55005d24a81a.toml
error: orchestrator: chooser: no feasible backend (considered 4 candidates) (backends tried: [])
; orch_err=Ryzen 9 7950X 16-Core Processor cache=/tmp/orch_parity_pi9ihn9j/cache/capability_6bfc55005d24a81a.toml
error: orchestrator: chooser: no feasible backend (considered 4 candidates) (backends tried: [])
