...
- **Next:** the fleet now works — scale it (≤128 Hetzner servers / 640 dedicated vCPUs / 4 TB volumes per the account cap, raised 2026-07-02; minus a few pre-existing user dev boxes) for
